...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Informacion del Usuario ') }}: {{$usuario->nombre}} </div>
                    ...
                    <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    name="nombre" disabled value="{{$usuario->nombre}} " 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="autor" type="text" class="form-control @error('apellido')
                                     is-invalid @enderror" disabled name="autor" value="{{$usuario->telefono}}" 
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Correo Electronico:') }}</label>
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      name="edit" disabled value="{{$usuario->email }}" 
                            ...
                            <div class="form-group row">
                                <label for="telefono" class="col-md-4 col-form-label text-md-right">{{ __('direccion:') }}</label>

                                  <div class="col-md-6">
                                      <input id="telefono" type="telefono" class="form-control @error('telefono') is-invalid @enderror"
                                      name="telefono" disabled value="{{ $usuario->direccion }}" 
                                      required autocomplete="email"></input>
                                  </div>
                                </label>
                                ...
                                <a class="btn btn-danger mb-3  align-items-center " style="float:center" href="{{route('usuarios.index')}}" >Regresar</a>
